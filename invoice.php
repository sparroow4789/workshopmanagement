...
<?php 
    ...
    $GetDatasql = "SELECT * FROM tbl_job_details tjd INNER JOIN tbl_tax tx ON tjd.job_id=tx.job_id INNER JOIN tbl_client tc ON tx.client_id=tc.client_id WHERE tjd.job_id= '$JobId' ";
    //OLD GET DATA
    ...
    $rs=$conn->query($GetDatasql);
        while($row =$rs->fetch_array())
        {
            ...
            // $currentYear = date('Y', strtotime($outdate));

            //////////////////////////////// 

            $client_address=$row[30];
        }
    ?>
                                    ...
                                    <div class="page-title">
                                        ...
                                        <?php 
                                            ...
                                            <?php if ($invoice_save_id==$tax_id) { ?>
                                                ...
                                                <?php if($email==''){ }else{ ?>
                                                <button type="button" id="SendEmailButton" onclick="SendEmail('<?php echo $JobId; ?>')" class="btn btn-default"><i class="fa fa-envelope"></i> Send Email</button>
                                                <?php } ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 text-right" id="logoimg">
                                                            ...
                                                            <b>
                                                                ...
                                                                <?php if ($invoice_save_id==$tax_id) { ?>
                                                                Job No : BAE/JOB/<?php echo $currentYear; ?>/<?php echo (10000+$tax_id); ?><br>
                                                                Invoice No : BAE/IN/<?php echo $currentYear; ?>/<?php echo (10000+$invoice_view_id); ?>
                                                                <?php }else{ ?>
                                                                Job No : BAE/JOB/<?php echo $currentYear; ?>/<?php echo (10000+$tax_id); ?>
                                                                <?php } ?>
                                                            </b>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <script>
                                                                                    var labour_view_status_<?php echo $job_labour_id;?> = 1;
                                                                                </script>
                                                                            ...
                                                                            ?>
                                                                        <tr id="labour-change-<?php echo $job_labour_id; ?>" style="cursor: pointer;">
                                                                        <!-- <tr onclick="switchVisible('labour_<?php echo $job_labour_id; ?>','expand-parts-<?php echo $job_labour_id; ?>','collapse-parts-<?php echo $job_labour_id; ?>');"> -->
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            while($rowitem =$rsitem->fetch_array())
                                                                                {
                                                                                    ...
                                                                                    // $Item_price = (double)$rowitem[16];
                                                                                    // $Item_discount = $rowitem[17];
                                                                            ...
                                                                            <tr id="collapse-parts-<?php echo $job_labour_id; ?>" class="trhideclass1<?php echo $job_labour_id; ?>">
                                                                        ...
                                                                        <?php } ?>
                                                                            ...
                                                                            <tr id="expand-parts<?php echo $labourId; ?>" style="display: none;">
                                                                                <td id="td" style="text-align: left; width: 50px;"><?php echo $LabourCount+=0.1; ?></td>
                                                                                <td id="td" style="text-align: left; width: 50px;">PART</td>
                                                                                <!--<td id="td" style="width: 600px; text-transform: uppercase;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php //echo $labour_name_1.' '.$labour_name_2; ?> PARTS / MATERIALS</td>-->
                                                                            ...
                                                                            <script>
                                                                                $(document).ready(function(){
                                                                                    $("#labour-change-<?php echo $job_labour_id; ?>").click(function(){

                                                                                        if(labour_view_status_<?php echo $job_labour_id; ?> === 1){
                                                                                            //////hide////
                                                                                            $('.trhideclass1<?php echo $job_labour_id; ?>').hide();
                                                                                            $("#expand-parts<?php echo $job_labour_id; ?>").show();
                                                                                            labour_view_status_<?php echo $job_labour_id; ?> = 0;
                                                                                        }else{
                                                                                            ////////show///
                                                                                            $('.trhideclass1<?php echo $job_labour_id; ?>').show();
                                                                                            $("#expand-parts<?php echo $job_labour_id; ?>").hide();
                                                                                            labour_view_status_<?php echo $job_labour_id; ?> = 1;
                                                                                        }
...
<script type="text/javascript">
        ...
        <script>
            // function switchVisible(labour,expandParts,collopsParts){
    ...
    <script>
        ...
        function SendEmail(job_id){
            ...
            $.ajax({
                ...
                url:"post/send_invoice_email.php",
                type: 'POST',
                data: {
                    job_id:job_id
                },
