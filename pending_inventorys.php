                    ...
                    <div class="col-lg-12">
                        <div class="card" style="background-color: #FFF;">
                            <div class="card-header">
                                <h3 class="card-title">Pending Inventorys</h3>
                            </div>
                            <div class="card-body">
                                
                                <div class="table-responsive">
                                    <table class="table table-hover table-vcenter table-striped" cellspacing="0" id="pendinginventorysTable">
                                        <thead>
                                            <tr>
                                                <th>Job Number</th>
                                                <th></th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM `tbl_vehicle_details` WHERE stat='1'";
                                                $rs=$conn->query($sql);
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                    <?php if($wiper_blades!=='' AND $windows_glass!=='' AND $replace_microfilter!='' AND $coolant!=='' AND $engine_oil!=='' AND $v_belt!=='' AND $noticeble_leaks!=='' AND $damage_animals!=='' AND $annual_check!=='' AND $shock!=='' AND $tyre_tread!=='' AND $engine_gearbox!=='' AND $front_axle!=='' AND $front_brake!=='' AND $rear_axle!=='' AND $rear_brake!=='' AND $brake_lines!=='' AND $exhaust_system!=='' AND $fuel_tank!==''){ }else{ ?>
                                                    <button type="button" onclick="location.href='update?v_id=<?php echo base64_encode($row[0]); ?>'" class="btn btn-success waves-effect waves-light">Update</button>
                                                    <?php } ?>
...
<script>
    $(document).ready( function () {
        $('#pendinginventorysTable').DataTable({
            "order": [[ 0, "desc" ]]
        });
    } );
</script>
