<?php
    ...
    if($_POST)
    {
        ...
        if(move_uploaded_file($_FILES['ksdfile']['tmp_name'], $location)){
            ...
            // $contents_list_6=preg_replace('&', '&amp;', $contents_list_5);
            // $contents_list_6 = preg_replace('\&', '_', $contents_list_5);
            ...
            if($count == 1){
                ...
                if(isset($position_data->flatRate->additionalInformation)){
                    ...
                    $conn->query("INSERT INTO tbl_job_labour VALUES(null, '$job_id', '$LABOUR_ID', '$FRU', '0', '$LABOURNAME', '$LABOURDETAILS', '$currentDate')");
