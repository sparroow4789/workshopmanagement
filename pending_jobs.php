                                    ...
                                    <table class="table table-hover table-vcenter table-striped" cellspacing="0" id="pendingjobsTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td><a href="job_card?j=<?php echo base64_encode($row[0]);?>" style="color: #000;"><?php echo $row[6]; ?></a></td>
                                                <td><a href="job_card?j=<?php echo base64_encode($row[0]);?>" style="color: #000;"><?php echo $row[9]; ?></a></td>
