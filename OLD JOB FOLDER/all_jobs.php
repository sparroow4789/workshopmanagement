                                    ...
                                    <table class="table table-hover table-vcenter table-striped" cellspacing="0" id="pendingjobsTable">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM `tbl_vehicle_details`";
                                                $rs=$conn->query($sql);
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td><a href="job_card?j=<?php echo base64_encode($row[0]);?>" style="color: #008000; font-weight: 600;"><?php echo $row[10]; ?></a></td>
                                                ...
                                                <td><a href="job_card?j=<?php echo base64_encode($row[0]);?>" style="color: #008000; font-weight: 600;"><?php echo $row[11]; ?></a></td>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td><a href="finish_job_card?j=<?php echo base64_encode($row[0]); ?>" style="color: #FF0000; font-weight: 600;"><?php echo $row[10]; ?></a></td>
                                                ...
                                                <td><a href="finish_job_card?j=<?php echo base64_encode($row[0]); ?>" style="color: #FF0000; font-weight: 600;"><?php echo $row[11]; ?></a></td>
