  <?php
    ...
    $TotalPriceWithFandCView=0;
    $itemIncomeSumTotalView=0;
    $itemCostSumTotalView=0;
    $itemDiscountDeferenceSumView=0;
    $itemFullIncomeSumTotalView=0;
    
    $TotalPriceWithFandIndividualCView=0;
    $itemIncomeSumTotalViewIndividual=0;
    $itemCostSumTotalViewIndividual=0;
    $itemDiscountDeferenceSumViewIndividual=0;
    $itemFullIncomeSumTotalViewIndividual=0;
    ...
    if(isset($_POST['stock_start_date']) && isset($_POST['stock_end_date'])){
            ...
            if ($priceBatchId == 0) {
                ...
                if($gic = $getItemCost->fetch_array()){
                    ...
                    if ($InternationalOrNot=='1') {
                        ...
                        $CurrenceyView = $Currencey.' '.$InternationalCost.' - '.$PriceWithFandCView;
                ...
                if($gic = $getItemCost->fetch_array()){
                    ...
                    if ($PBInternationalOrNot=='0') {
                        ...
                        $CurrenceyView = $PBCurrencey.' '.$InternationalCost.' - '.$PriceWithFandCView;
      ...
      $obj='
            ...
            <tr>
                ...
                <td>'.$itemName.' ('.$itemNumber.')</td>
                
                <td style="text-align: center;"><font style="color: #03AC13; font-weight: 800;">'.$itemQtySum.'</font></td>
                <td style="text-align: center;"><font style="color: #00008B; font-weight: 800;">BAE/IN/'.$InvoiceYear.'/'.$InvoiceNumber.' <br> BAE/GRN/'.$GRNYear.'/'.$GRNNumber.' <br> ('.$SupplierName.')</font></td>
