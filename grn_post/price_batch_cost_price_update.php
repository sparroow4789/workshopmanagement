<?php
    ...
    if(isset($_POST['batch_id']) && isset($_POST['item_id']) && isset($_POST['new_price'])){
        ...
        if($batch_id=='0'){
            ...
            $UpdateNormalSql = "UPDATE tbl_item_cost SET cost='$new_price' WHERE item_id='$item_id' ";
            if ($conn->query($UpdateNormalSql) === TRUE){

                $output['result'] = true;
                $output['msg'] = 'Cost price updated';
            ...
            $UpdatePriceBatchSql = "UPDATE tbl_item_price_batch SET cost_price='$new_price' WHERE price_batch_id='$batch_id' AND item_id='$item_id' ";
